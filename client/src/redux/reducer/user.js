...
const usersSlice = createSlice({
  ...
  initialState: {
    ...
    loggedUser: Cookies.get("crm_profile")
      ? JSON.parse(Cookies.get("crm_profile"))
      : null,
  },
  reducers: {
    start: (state) => {
    ...
    filterEmployeeReducer: (state, action) => {
      ...
      const filteredEmployees = allEmployees.filter((employee) => {
        ...
        if (
          ...
          employee.martialStatus.toLowerCase() !=
            filters.martialStatus.toLowerCase()
        )
          return false;
        if (
          filters.gender &&
        ...
        if (
          ...
          employee?.salaryType.toLowerCase() !=
            filters?.salaryType.toLowerCase()
        )
          return false;
        return true;
      });
